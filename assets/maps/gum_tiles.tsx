...
<tileset version="1.10" tiledversion="1.11.2" name="gum_tiles" tilewidth="16" tileheight="16" tilecount="8" columns="8">
 <image source="../images/Coin.png" width="128" height="16"/>
 <tile id="0">
  <animation>
